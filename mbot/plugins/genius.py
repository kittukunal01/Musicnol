    ...
    #      rpl = lyrics(song)
          ...
          try:
            ...
            await message.reply(rpl)
             ...
             await message.reply_text(f"lyrics does not found for `{song} {e}`") #", quote = True, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url = f"https://t.me/RedMoviees")]]))
          finally:
            await message.reply("Check out @RedOfficiall")
