...
async def sng(bot, message):          
          ...
          try:
            ...
            await message.reply(rpl)
             ...
             await message.reply_text(f"lyrics does not found for `{song}` ", quote = True, reply_markup = InlineKeyboardMarkup([[InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url = f"https://t.me/TomenBots")]]))
          finally:
            await message.reply("Check out @TomenMusicBot(music)  @TomenBots(News)")
